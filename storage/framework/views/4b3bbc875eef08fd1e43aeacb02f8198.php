...
<div class="box box-warning">
    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <form id="add-response-form" method="POST" action="<?php echo e(route('tickets.add-response', $ticket->id)); ?>">
                            <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6">
                <div class="box box-solid">
                    ...
                    <div class="box-body">
                        <form id="update-status-form" method="POST" action="<?php echo e(route('tickets.update-status', $ticket->id)); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
        ...
        <?php if($ticket->ticket_status->status != 'Resolved' && $ticket->ticket_status->status != 'Closed'): ?>
        <div class="row">
            <div class="col-md-12">
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <form id="complete-ticket-form" method="POST" action="<?php echo e(route('tickets.complete-with-resolution', $ticket->id)); ?>">
                            <?php echo csrf_field(); ?>
...
<div class="modal fade" id="stop-timer-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="stop-timer-form" method="POST" action="<?php echo e(route('tickets.stop-timer', $ticket->id)); ?>">
                <?php echo csrf_field(); ?>
...
$(document).ready(function() {
    ...
    $('#start-timer-btn').click(function() {
        $.post('<?php echo e(route("tickets.start-timer", $ticket->id)); ?>', {
            _token: '<?php echo e(csrf_token()); ?>',
            description: 'Bekerja pada tiket: <?php echo e($ticket->subject); ?>'
        })
    ...
    function checkTimerStatus() {
        $.get('<?php echo e(route("tickets.timer-status", $ticket->id)); ?>')
        .done(function(response) {
    ...
    function loadWorkSummary() {
        $.get('<?php echo e(route("tickets.work-summary", $ticket->id)); ?>')
        .done(function(response) {
...
</script><?php /**PATH D:\Project\ITQuty\quty2\resources\views\tickets\partials\technician-panel.blade.php ENDPATH**/ ?>