        ...
        <div class="box-body">
          <form method="POST" action="<?php echo e(url('assets')); ?>">
            ...
            <div class="form-group">
              ...
              <select class="form-control asset_model_id" name="asset_model_id">
                ...
                <?php $__currentLoopData = $asset_models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset_model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($asset_model->id); ?>"><?php echo e($asset_model->manufacturer->name); ?> - <?php echo e($asset_model->asset_model); ?></option>
            ...
            <div class="form-group">
              ...
              <input type="text" name="mac" class="form-control" value="<?php echo e(old('mac')); ?>">
            </div>
            <div class="form-group">
