  ...
  <div class="row">
    <div class="col-md-9">
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <span class="count-badge"><?php echo e(count($manufacturers)); ?></span>
        </div>
        <div class="box-body">
          <table id="table" class="table table-enhanced table-striped table-hover">
            ...
            <tbody>
              <?php $__empty_1 = true; $__currentLoopData = $manufacturers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manufacturer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><strong><?php echo e($manufacturer->name); ?></strong></td>
                    <td>
                      <a href="/manufacturers/<?php echo e($manufacturer->id); ?>/edit" class="btn btn-xs btn-warning" title="Edit">
    ...
    <div class="col-md-3">
      <div class="box box-success">
        ...
        <div class="box-body">
          <form method="POST" action="<?php echo e(url('manufacturers')); ?>" id="manufacturer-form">
            ...
            <fieldset>
              ...
              <div class="form-group <?php echo e(hasErrorForClass($errors, 'name')); ?>">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="name" id="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="e.g., Dell, HP, Lenovo" required>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\quty2\resources\views/manufacturers/index.blade.php ENDPATH**/ ?>