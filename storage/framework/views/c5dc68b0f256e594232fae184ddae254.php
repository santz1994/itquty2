        ...
        <div class="box-body">
          <form method="POST" action="<?php echo e(url('models')); ?>">
            ...
            <div class="form-group <?php echo e(hasErrorForClass($errors, 'asset_model')); ?>">
              ...
              <input type="text"  name="asset_model" class="form-control" id="asset_model" value="<?php echo e(old('asset_model')); ?>">
            ...
            <div class="form-group <?php echo e(hasErrorForClass($errors, 'part_number')); ?>">
              ...
              <input type="text"  name="part_number" class="form-control" id="part_number" value="<?php echo e(old('part_number')); ?>">
