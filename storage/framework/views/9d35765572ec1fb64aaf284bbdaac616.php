            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="warrantyTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $warrantyTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $warranty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($warranty->id); ?></td>
                                <td>
                                    <span class="badge badge-secondary">
                                        <?php echo e($warranty->name); ?>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <button type="button" class="btn btn-info btn-edit-warranty" 
                                                ...
                                                data-name="<?php echo e($warranty->name); ?>"
                                                data-toggle="modal" data-target="#editWarrantyModal">
                                            <i class="fa fa-edit"></i> Edit
                                        </button>
                                        <form method="POST" action="<?php echo e(route('warranty-types.destroy', $warranty->id)); ?>" 
...
<div class="modal fade" id="addWarrantyModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('warranty-types.store')); ?>">
                <?php echo csrf_field(); ?>
...
$(document).ready(function() {
    ...
    $('.btn-edit-warranty').on('click', function() {
        ...
        $('#edit_name').val(name || '');
        $('#editWarrantyForm').attr('action', '<?php echo e(route("warranty-types.update", ":warranty")); ?>'.replace(':warranty', id));
    });
});
</script>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\Quty1\resources\views/system-settings/asset-configs/warranty-types.blade.php ENDPATH**/ ?>