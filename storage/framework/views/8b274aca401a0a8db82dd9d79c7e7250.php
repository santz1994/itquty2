...
<div class="file-uploader-component" id="<?php echo e($uploadId); ?>">
    <div class="box box-default">
        <div class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <button type="button" class="btn btn-primary btn-sm" onclick="document.getElementById('<?php echo e($uploadId); ?>-input').click()">
        ...
        <div class="box-body">
            <!-- Hidden file input -->
            <input type="file" 
                   id="<?php echo e($uploadId); ?>-input" 
                   multiple 
                   accept="<?php echo e($accept); ?>"
                   style="display: none;" 
                   onchange="handleFileSelect(this, '<?php echo e($uploadId); ?>', '<?php echo e($model_type); ?>', <?php echo e($model_id); ?>, '<?php echo e($collection); ?>', <?php echo e($max_files); ?>)">
            
            <!-- Upload progress -->
            <div id="<?php echo e($uploadId); ?>-progress" class="upload-progress" style="display: none;">
                <div class="progress">
            ...
            <!-- File list -->
            <div id="<?php echo e($uploadId); ?>-list" class="attachments-list">
...
function uploadFiles(files, uploaderId, modelType, modelId, collection) {
    ...
    fetch('<?php echo e(route("attachments.bulk-upload")); ?>', {
        method: 'POST',
        body: formData,
    })
...
function loadAttachments(uploaderId, modelType, modelId, collection) {
    ...
    fetch(`<?php echo e(route("attachments.index")); ?>?model_type=${modelType}&model_id=${modelId}&collection=${collection}`)
        .then(response => response.json())
        .then(data => {
            hideLoading();
        ...
        html += `
            <div class="attachment-item" data-id="${attachment.id}">
                ...
                <div class="attachment-actions">
                    <a href="<?php echo e(url('/')); ?>/attachments/${attachment.id}/download" 
...
function deleteAttachment(attachmentId, uploaderId) {
    ...
    fetch(`<?php echo e(url('/')); ?>/attachments/${attachmentId}`, {
        method: 'DELETE',
        headers: {
...
document.addEventListener('DOMContentLoaded', function() {
    const uploaderId = '<?php echo e($uploadId); ?>';
    const modelType = '<?php echo e($model_type); ?>';
    const modelId = <?php echo e($model_id); ?>;
    const collection = '<?php echo e($collection); ?>';
    
    loadAttachments(uploaderId, modelType, modelId, collection);
});
</script>
<?php /**PATH D:\Project\ITQuty\quty2\resources\views\partials\file-uploader.blade.php ENDPATH**/ ?>