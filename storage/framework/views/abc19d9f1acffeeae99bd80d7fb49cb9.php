...
<body class="hold-transition login-page" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); min-height: 100vh;">
        ...
        <div class="login-box-body" style="background: white; border-radius: 15px; padding: 40px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); border: none;">
            ...
            <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
                <p style="color: #999; font-size: 12px; margin: 0;">
                    ...
                    Secure login with session timeout (<?php echo e(config('session.lifetime')); ?> minutes)
                </p>
    ...
    <script>
        ...
        let inactivityTimer;
        let warningTimer;
        const sessionTimeout = <?php echo e(config('session.lifetime') * 60); ?>; // Convert to seconds
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\quty2\resources\views/auth/login.blade.php ENDPATH**/ ?>