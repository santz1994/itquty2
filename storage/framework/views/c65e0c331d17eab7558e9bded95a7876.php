                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td><?php echo e($systemInfo['app_version']); ?></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($systemInfo['database_connection']); ?></td>
                            </tr>
                            <tr>
                                <td><strong>Cache Driver</strong></td>
                                <td><?php echo e($systemInfo['cache_driver']); ?></td>
                            </tr>
                            <tr>
                                <td><strong>Session Driver</strong></td>
                                <td><?php echo e($systemInfo['session_driver']); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <div class="btn-group-vertical" role="group" style="width: 100%;">
                            ...
                            <a href="<?php echo e(route('system.roles')); ?>" class="btn btn-info">
                                <i class="fa fa-users"></i> Manage Roles
                            </a>
                            <a href="<?php echo e(route('system.maintenance')); ?>" class="btn btn-warning">
                                <i class="fa fa-wrench"></i> System Maintenance
                            </a>
                            <a href="<?php echo e(route('system.logs')); ?>" class="btn btn-default">
                            ...
                            <div class="col-md-3">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php echo e(ucfirst($systemInfo['cache_driver'])); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php echo e(ucfirst($systemInfo['queue_driver'])); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php echo e(ucfirst($systemInfo['session_driver'])); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\quty2\resources\views/system/settings.blade.php ENDPATH**/ ?>