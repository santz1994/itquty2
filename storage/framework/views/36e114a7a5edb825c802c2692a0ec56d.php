                                        ...
                                        <select class="form-control" id="role_id" name="role_id" required>
                                            ...
                                            <?php if(isset($roles)): ?>
                                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($role && is_object($role) && isset($role->id) && isset($role->name)): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\quty2\resources\views/admin/users/create.blade.php ENDPATH**/ ?>