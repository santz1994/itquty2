    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form action="<?php echo e(route('sla.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $priorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($priority->id); ?>" 
                                                    <?php echo e(old('priority_id') == $priority->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                              ...
                                              name="description" 
                                              rows="3" 
                                              placeholder="Describe when and how this SLA policy should be used"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="response_time" 
                                           name="response_time" 
                                           value="<?php echo e(old('response_time')); ?>" 
                                           min="1"
                                           placeholder="e.g., 60"
                                           required>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('resolution_time')); ?>" 
                                           min="1"
                                           placeholder="e.g., 240"
                                           required>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" 
                                               ...
                                               value="1"
                                               <?php echo e(old('business_hours_only', 1) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           value="<?php echo e(old('escalation_time')); ?>" 
                                           min="1"
                                           placeholder="e.g., 120">
...
unset($__errorArgs, $__bag); ?>" 
                                        ...
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($user->id); ?>" 
                                                    <?php echo e(old('escalate_to_user_id') == $user->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\quty2\resources\views\sla\create.blade.php ENDPATH**/ ?>