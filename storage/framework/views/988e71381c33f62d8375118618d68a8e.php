        ...
        <div class="box-body">
          <form method="POST" action="<?php echo e(url('tickets')); ?>">
            ...
            <div class="form-group">
              <label for="user_id"><?php if($errors->has('user_id')): ?><span class="text-red">Agent <small>'<?php echo e($errors->first('user_id')); ?>'</small></span><?php else: ?> Agent <?php endif; ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\Quty1\resources\views/tickets/create.blade.php ENDPATH**/ ?>