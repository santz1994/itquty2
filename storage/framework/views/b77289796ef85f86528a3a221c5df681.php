            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        ...
                        <a href="<?php echo e(route('audit-logs.export', request()->all())); ?>" class="btn btn-success btn-sm" title="Export to CSV">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $auditLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <small><?php echo e(Str::limit($log->description, 80)); ?></small>
                                            </td>
                                            <td>
                                                <?php
                                                    $eventTypeBadgeClass = [
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\Quty1\resources\views/audit_logs/index.blade.php ENDPATH**/ ?>