                    ...
                    <form action="<?php echo e(route('asset-requests.store')); ?>" method="POST">
                                    ...
                                    <select class="form-control" id="asset_type_id" name="asset_type_id" required>
                                        ...
                                        <?php $__currentLoopData = $assetTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($type->id); ?>" 
                                                    <?php echo e(old('asset_type_id') == $type->id ? 'selected' : ''); ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="priority" name="priority" required>
                                        ...
                                        <?php $__currentLoopData = $priorities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($priority); ?>" 
                                                    <?php echo e(old('priority') == $priority ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="requested_quantity" name="requested_quantity" 
                                           value="<?php echo e(old('requested_quantity', 1)); ?>" min="1" max="99" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="estimated_cost" name="estimated_cost" 
                                           value="<?php echo e(old('estimated_cost')); ?>" min="0" step="1000">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="needed_date" name="needed_date" 
                                           value="<?php echo e(old('needed_date')); ?>" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="usage_duration" name="usage_duration">
                                        ...
                                        <option value="temporary" <?php echo e(old('usage_duration') == 'temporary' ? 'selected' : ''); ?>>
                                            Sementara (< 3 bulan)
                                        </option>
                                        <option value="medium_term" <?php echo e(old('usage_duration') == 'medium_term' ? 'selected' : ''); ?>>
                                            Menengah (3-12 bulan)
                                        </option>
                                        <option value="permanent" <?php echo e(old('usage_duration') == 'permanent' ? 'selected' : ''); ?>>
                                            Permanen (> 12 bulan)
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="business_justification" name="business_justification" 
                                      rows="4" required><?php echo e(old('business_justification')); ?></textarea>
                            <small class="form-text text-muted">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="alternative_solutions" name="alternative_solutions" 
                                      rows="3"><?php echo e(old('alternative_solutions')); ?></textarea>
                            <small class="form-text text-muted">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="preferred_specifications" name="preferred_specifications" 
                                      rows="3"><?php echo e(old('preferred_specifications')); ?></textarea>
                            <small class="form-text text-muted">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="supervisor_approval" 
                                               name="supervisor_approval" value="1" <?php echo e(old('supervisor_approval') ? 'checked' : ''); ?>>
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="budget_approved" 
                                               name="budget_approved" value="1" <?php echo e(old('budget_approved') ? 'checked' : ''); ?>>
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="replacement_asset" 
                                               name="replacement_asset" value="1" <?php echo e(old('replacement_asset') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\Quty1\resources\views/asset-requests/create.blade.php ENDPATH**/ ?>