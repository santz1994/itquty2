...
Asset History - <?php echo e($asset->asset_tag); ?>
  ...
  <div class="col-md-12">
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
          <i class="fa fa-history"></i> Asset History: <?php echo e($asset->asset_tag); ?>
          ...
          <div class="col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo e($asset->asset_tag); ?></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo e($ticketHistory->count()); ?></span>
              </div>
            </div>
          </div>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="label label-primary"><?php echo e($ticket->ticket_status->name); ?></span>
                    </td>
                    <td><?php echo e($ticket->created_at->format('M d, Y H:i')); ?></td>
                    <td>
                      <a href="<?php echo e(route('tickets.show', $ticket->id)); ?>" class="btn btn-xs btn-primary">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo e($ticket->ticket_type->name ?? 'N/A'); ?></td>
                    <td><?php echo e($ticket->title); ?></td>
                    <td>
                      <span class="label label-<?php echo e($ticket->ticket_priority->id == 1 ? 'danger' : ($ticket->ticket_priority->id == 2 ? 'warning' : 'info')); ?>">
                        <?php echo e($ticket->ticket_priority->name); ?>
                    ...
                    <td><?php echo e($ticket->user->name ?? 'Unassigned'); ?></td>
                    <td><?php echo e($ticket->created_at->format('M d, Y H:i')); ?></td>
                    <td>
                      <?php if($ticket->resolved_at): ?>
                        <?php echo e($ticket->created_at->diffForHumans($ticket->resolved_at, true)); ?>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    <tr>
                      ...
                      <td><?php echo e($asset->getMaintenanceTicketsCount()); ?></td>
                    </tr>
                    <tr>
                      <td><strong>Average Resolution Time:</strong></td>
                      <td>
                        <?php if($asset->getAverageResolutionTime()): ?>
                          <?php echo e(round($asset->getAverageResolutionTime() / 60, 1)); ?> hours
                        <?php else: ?>
                          N/A
                        <?php endif; ?>
                      </td>
                    ...
                    <tr>
                      ...
                      <td><?php echo e($asset->purchase_date ? $asset->purchase_date->diffForHumans() : 'Unknown'); ?></td>
                    </tr>
                    <tr>
                      <td><strong>Warranty Status:</strong></td>
                      <td>
                        <span class="label label-<?php echo e($asset->warranty_status == 'Active' ? 'success' : ($asset->warranty_status == 'Expiring soon' ? 'warning' : 'danger')); ?>">
                          <?php echo e($asset->warranty_status); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\ITQuty\quty2\resources\views/admin/assets/history.blade.php ENDPATH**/ ?>