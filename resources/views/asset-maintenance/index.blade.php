...
<div class="row">
    <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-yellow">
            <div class="inner">
                <h3>{{ $stats['assets_needing_maintenance'] }}</h3>
    ...
    <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-blue">
            <div class="inner">
                <h3>{{ $stats['scheduled_maintenance'] }}</h3>
    ...
    <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-orange">
            <div class="inner">
                <h3>{{ $stats['overdue_maintenance'] }}</h3>
...
<div class="row">
    <div class="col-md-8">
        <div class="box box-warning">
            ...
            <div class="box-body">
                @if($assetsRequiringMaintenance->count() > 0)
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        @if($asset->is_lemon_asset)
                                            <span class="label label-danger">Problematic</span>
                                        @endif
                                    </td>
                                    <td>{{ $asset->model->name ?? 'Unknown' }}</td>
                ...
                @if($maintenanceSchedule->count() > 0)
                    ...
                    <div class="media maintenance-item">
                        <div class="media-left">
                            <i class="fa fa-{{ $schedule['priority'] === 'high' ? 'fire text-red' : 'wrench text-yellow' }} fa-2x"></i>
                        </div>
                        <div class="media-body">
                            ...
                            <p class="text-muted">{{ $schedule['asset']->model->name ?? 'Unknown Model' }}</p>
                            <small class="text-info">
                                <i class="fa fa-calendar"></i> Due: {{ $schedule['recommended_date']->format('d/m/Y') }}
                            </small>
                            <br>
                    ...
                    @if($maintenanceSchedule->count() > 10)
                        <div class="text-center">
                            <small class="text-muted">And {{ $maintenanceSchedule->count() - 10 }} more items...</small>
                        </div>
                    @endif
                @else
