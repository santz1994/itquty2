...
<section class="dashboard-container">
    ...
    <div class="dashboard-header">
        ...
        <div class="header-actions">
            <div class="server-time">
                <i class="fas fa-clock"></i> <span id="server-time">{{ now()->format('Y-m-d H:i:s') }}</span>
            </div>
            @if(Route::has('reports.index'))
                <a href="{{ route('reports.index') }}" class="btn btn-sm">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card stat-card-assets">
            ...
            <h2 class="stat-value">{{ \App\Asset::count() }}</h2>
        ...
        <div class="stat-card stat-card-tickets">
            ...
            <h2 class="stat-value">{{ \App\Ticket::where('ticket_status_id', '!=', \App\TicketsStatus::where('status', 'Closed')->value('id'))->count() ?? 0 }}</h2>
        ...
        <div class="stat-card stat-card-movements">
            ...
            <h2 class="stat-value">{{ isset($movements) ? $movements->count() : 0 }}</h2>
                        ...
                        <ul class="timeline">
                            @foreach($movements as $movement)
                                ...
                                <li class="timeline-item">
                                    <div class="timeline-marker" title="{{ $createdDate->format('Y-m-d H:i:s') }}">
                                        {{ $loop->iteration }}
                                    </div>
                                    <div class="timeline-content">
                                        <div class="timeline-header">
                                            <div class="timeline-user">
                                                <h4 class="user-name">{{ $movement->user->name }}</h4>
                                                <span class="user-action">Moved Asset</span>
                                            </div>
                                            <span class="timeline-time">
                                                {{ $createdDate->format('H:i') }}
                                                <br>
                                                <small>{{ $createdDate->diffForHumans() }}</small>
                                            </span>
                                        </div>
                                        <div class="timeline-body">
                                            <div class="movement-details">
                                                <div class="detail-item">
                                                    ...
                                                    <span class="detail-value">{{ $asset->asset_tag ?? 'N/A' }}</span>
                                                </div>
                                                <div class="detail-item">
                                                    <span class="detail-label">Model</span>
                                                    <span class="detail-value">
                                                        {{ ($asset->model ? $asset->model->manufacturer->name . ' ' . $asset->model->asset_model : 'N/A') }}
                                                    </span>
                                                </div>
                                                <div class="detail-item">
                                                    <span class="detail-label">Location</span>
                                                    <span class="detail-value">{{ $movement->location->location_name ?? 'N/A' }}</span>
                                                </div>
                                                <div class="detail-item">
                                                    <span class="detail-label">Status</span>
                                                    <span class="detail-value">{{ $movement->status->name ?? 'N/A' }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="card card-modern">
                ...
                <div class="card-body sidebar-card-body">
                    <div class="action-list">
                        <a href="{{ route('assets.create') ?? '#' }}" class="action-item">
                        ...
                        <a href="{{ route('tickets.create') ?? '#' }}" class="action-item">
                            <span class="action-icon">
                                <i class="fas fa-plus"></i>
                            </span>
                        ...
                        <a href="{{ route('assets.index') ?? '#' }}" class="action-item">
                            <span class="action-icon">
                        ...
                        <a href="{{ route('tickets.index') ?? '#' }}" class="action-item">
                            <span class="action-icon">
                                <i class="fas fa-list"></i>
                            </span>
