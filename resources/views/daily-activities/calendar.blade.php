        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    @if(Auth::user()->hasRole(['admin', 'super-admin']) && $users->count() > 0)
...
<div class="modal fade" id="createActivityModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="createActivityForm" method="POST" action="{{ route('daily-activities.store') }}">
                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: {
            url: '{{ route("daily-activities.calendar-events") }}',
            method: 'GET',
    ...
    function loadDateActivities(date) {
        var url = '{{ route("daily-activities.date-activities") }}';
